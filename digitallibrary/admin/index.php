	...
	<div class="content mt-3">
		<div class="card bg-primary bg-gradient">
			<div class="card-body">
				...
				<a href="#" class ="btn btn-light text-primary">HOME</a>
				<a href="kategoribuku.php" class ="btn btn-light text-primary">KATEGORI BUKU</a>
				...
				<a href="../logout.php" class ="btn btn-warning text-light">LOGOUT</a>
			</div>
		</div>
	</div>
		<div class="content mt-3">
		...
		<div class="content mt-3"> 
			<p class="text-center">@2024 UKK Aplikasi Perpustakaan Digital By.sa</p>
	</div>
